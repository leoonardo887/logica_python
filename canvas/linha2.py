...
canvas.create_line(
    ...
    fill='red',          #e os dois 200 são os pontos onde termina a linha
    width=3
)

canvas.create_line(
    10,10,200,10,         #os dois primeiros 10 são o ponto onde começa a linha
    fill='blue',          #e os dois 200 são os pontos onde termina a linha
    width=3
)

canvas.create_line(
    10,10,200,200,         #os dois primeiros 10 são o ponto onde começa a linha
